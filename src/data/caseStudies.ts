...
const caseStudyModules = import.meta.glob('./caseStudies/*.md', { query: '?raw', eager: true }) as Record<
  string,
  { default: string }
>;
...
export const CASE_STUDIES: CaseStudyDetail[] = Object.entries(caseStudyModules).map(([path, module]) => {
